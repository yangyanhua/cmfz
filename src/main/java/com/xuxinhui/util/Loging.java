...
import com.xuxinhui.entity.Journal;
import com.xuxinhui.service.JournalService;
...
public class Loging {
    ...
    @Around("@annotation(com.xuxinhui.annotation.Logging)") //第二种 直接指定注解权限定名,那个方法用了此注解就能以切入点切入
